      ...
      tokenToString = function tokenToString(token) {
        ...
        switch (token) {
          ...
          case "ZZZ":
            // like +0600
            return formatOffset({
              formqı™aî—á2â  @áÿr√åGı–Q¿√ä˘På@JπÒÖ    ß ß ß Bß ß nß 4ß Fß ØYØ'ØSØØØ'ØSØ return dt.zone.offsetName(dt.ts, {
              format: "shortÇ¨zë!‡     b( @-"ò/à;b( SXË!	    †7(

       case "ZZZZZ":
            // like Eastern Standard Time
    êëë°!‡  ÍTPqgM Ùc(ÙdÕD~VZdhdR&QIe$cR∆cg¨[	 †   †  ∂VNÌW  U/˜ËZ»˜Ë8À˜Ë=÷˜ËS˜Ë6»˜Ë8À˜Ë=÷˜ËS˜Ë67˜Ë°B˜ËÜÛ˜Ëò"˜Ëï»˜Ëû“˜ËP˜˜Ë          // zone
          case "z":
            // like America/New_York
            return dt.zoneName;
          // meridiemÛzë°‡Ä ∞ ¬@†Ä ~Ä   Ä   :T– 9ÅS∞0¿B   Ä     ó1µr`       ∞  Ä Ä            Ä   @ @  
@Ä    ter ? string({
              day: "numeric"
            }, "day"ë°™14CÅqHÅq¿
†—A ‡ Ë ‡  ôÅ  …A ‡ Ë ‡ Ë èÅ"@P  •á	;BUBBÓªƒï;˜Ëj7˜Ë°B˜ËL‹˜Ëò4˜ËB“˜Ëv˜ËMÃ˜ËS˜Ë6»˜Ë8À˜Ë=÷˜ËS˜Ë6»˜Ë8Ë˜Ëå⁄˜ËôAÑ≈
e@5ê( `Ä Ä Ä `@`hÄ	–Ä `Ä Ä Ä `Ä †
Ä Ö@Ä( `Ä Ä Ä      return _this.num(dt.weekday);
          case "ccc":
         êë1è!‡ÀÉTÍ§E4[&¿!Ä¯& ÄÄaAcrKf)ÂZ£ ÏlXOÃ!†b“’   êëë°!‡¿	cY†„S¥   †   -*‡
SY #3cB·m&	 †   †  turn weekday("long", true);
          case "ccccc":
            ?üÅ¸	                                                             // weekdays - format
          case "E":
            // like 1
          ...
          case "EEE":rëëë!‡    ŒP_Ë!Ä4a\#
      †-D=bd 2ÂD_PX¥$“BSh4  ∞≤ådÊD6
        Caie ≤D)E?‚7
       ‡-/ Liae «SUeida…&
            return weekday("long", false);
          case "EEEEE":
            // like 'T'
            return weekday("narrow", falcˆôã‡DgÄ∏D ÄäA4–ƒè¡-`PãA1`∏DgÄ∏ó@>¿FÅRÄ∏        // like 1
            return useDateTimeFormatter ? stringê˚zë!‡       Kmd¥G2 ÏjÏDRQY (
       ¿Aa4 mÌTPiZ  êëë°!‡    q ¢Tcli¬ 2 Vìc(ljåÙcÌdmR@!3à   † ¿:QOÂ  L":
...
†‰±Ù 1tAâ·H  
†@  
 8LÍEa4h  *  R^∂Õ!‡„≈LQŸ∞{Í´ pí  p«Sﬁd —C2ît&pí  píË–IQ—`&  
            return month("short", true);
          case "LLLL":rëë±!‡   †ÆP]h!I!Rh`-i	 †   †“DHafÏÌMZ`\®ÏMS¨  ue);
          case "LLLLL":
            // like J
            return month("narrow", true);
          // months - format
      êëëAdAhe ¢L8	       -+‡jc] ¨	       h•r5jb ÍÚd$YPe  YFWØ	(¿
– x %¿¿ ¨ -  0 @  @ 0 @  @
¿ » +@¿¥ #¿0 @  @ 0 @     }, "month") : _this.num(dt.month);
          case "MM":
            // like 01
            return useDateTimeFormatter ? strinô˚ö‡¿   ¿ x@ t Ä@	Ñ  ¿   ¿ Ù@†
¯ ä¿h  is.num(dt.month, 2);
          case "MMM":
            // like JÅÓz±‡  ¿( ÄR–\@≈ê	v¿–Ã∏zêà¬¿(  ¿(H¿R–ÿ  Ö£∫ä‡     A†
∏ƒ@¿@SÄS0       ‹tA0ò 0®   false);
          case "MMMMM":
            // like J
         òëacfj-m†cbi§ÁëMYfh+5¬+^X®ÒDŸ6
   ‡ç.m\û03
     ase "y":
            // like 2014
            return useDateTimeFormatter ? string({
              year: "numeric"
            }îa√ifah^(1]idh„ÂMuc§c‰%UeXn(

     ùaÛd"n5"	
        // like 14
            return useDateTimeFormatter ? string({
 êëë°!‡   †Ÿ!b2†“<QEii"	 †   †<Ë!UÂW¬ 2 Vìc(lj  tïŒifag*rShr_™fÈsb%cU()2%( È2
     C!OeﬁvXym"4
           // like 0012
            return useDateTimeFormatter ? string({
              year: "numeric"
            }, "year") : _thiì^^∂àπÄ àp¿ ‡` pÄ Ä ` pÄ@` Ã¿!`§–  Ä ` pÄ Ä ` ¨Ä 0l  ®°°Å2	     ‹aT.ÈaLúdRa<QR·KH)Ÿ5-ÓdQnËTP\6 mËa(™^5
    66úm7úf:úf 6úh6;úm9úih:úg 7úhá8ús!7úo97úf 6úh66úm7úf:úf 6úh°√úâF ƒ \ƒ\D,‡E ƒ ƒC*‡)‹@$Aƒ ƒ¥·d  e AD
            return era("short");
          case "GG":
            // like Anno Domini
            return era("long");
     êëëë!C+[ ü¶FˆA¢¥	    †mt<jd†·Ma¯d—Ìn>⁄$9	       ase "kk":
...
var Interval = /*#__PURE__*/function (_Symbol$for) {
  ...
  _proto.toFormat = function toFormat(dateFormat, _temp2) {
    var _ref3 = _temp2 === void 0 ? {} : _temp2,
      ...
      separator = _ref3$separator === void 0 ? " ‚Äì " : _ref3$separator;
    if (!this.isValid) return INVALID$1;
